...
# ======== BEGIN: Multilingual FAQ Suggestion Logic (Always Show Prompts) ========
import pandas as pd
import os
...
def load_faq():
    ...
    # If not already categorized, auto-categorize
...
def show_faq_suggestions(tab_category, lang="English"):
    ...
    st.markdown(headers.get(lang, "💡 **Suggested questions:**"))
...
# ======== END: Multilingual FAQ Suggestion Logic ========
